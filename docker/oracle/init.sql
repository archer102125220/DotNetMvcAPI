...
CREATE USER "dot-net-mvc-api" IDENTIFIED BY "DotNetMvcApiAbc123";

-- 賦予連線 (CONNECT)、資源建立權 (RESOURCE)，以及最高管理員權限 (DBA)
-- 擁有 DBA 權限後，該帳號就能存取 FREEPDB1 內任意其他的 Schema 空間
GRANT CONNECT, RESOURCE, DBA TO "dot-net-mvc-api";

-- 開放該帳號(Schema)無限制的儲存空間配額，允許其自由建立 Tables
ALTER USER "dot-net-mvc-api" QUOTA UNLIMITED ON USERS;
...
-- 
-- 屆時，您的主帳號 "dot-net-mvc-api" 因為擁有 DBA 權限，
